...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-db', type=str, help='Path to save the dot-bracket notation', default=None)
    parser.add_argument('--save-cm', type=str, help='Path to save the .npy contact map', default=None)
    parser.add_argument('--save-plot', type=str, help='Path to save the contact map plot', default=None)
    ...
    if db_path:
        ...
        with open(db_path, 'w') as f:
            f.write(f'{seq}\n{db}')
        print(f'Dot-bracket secondary structure saved to {db_path}')
    ...
    if cm_path:
        np.save(cm_path, contact_map)
        print(f'Contact map secondary structure saved to {cm_path}')
    
    # plot the visualization of the cm map
    if plot_path:
        ...
        print(f'Secondary structure contact map plot saved to {plot_path}')
